...
export const CLEAR_COMPLETED_TODO = '[TODO] Limpia todos completados';
...
export type Acciones = AgregarTodoAction | ToggleTodoAction | EditarTodoAction | EliminarTodoAction | ClearCompleted;
